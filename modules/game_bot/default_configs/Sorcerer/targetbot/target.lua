...
targetbotMacro = macro(100, function()
  ...
  if highestPriorityParams and not isInPz()
    and highestPriorityParams.creature:getName() ~= "Skullfrost"
    and highestPriorityParams.creature:getName() ~= "Emberwing"
    and highestPriorityParams.creature:getName() ~= "Thundergiant"
    and highestPriorityParams.creature:getName() ~= "Grovebeast"
  then
