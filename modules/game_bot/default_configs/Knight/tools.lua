...
-- if type(storage.antipushItems) ~= "table" then
--   storage.antipushItems = {3031, 3492}
-- end

-- local antipushContainer = UI.Container(function(widget, items)
--   storage.antipushItems = items
-- end, true)
-- antipushContainer:setHeight(35)
-- antipushContainer:setItems(storage.antipushItems)

-- macro(100, "Loot antipush", function()
